...
- (void)viewDidLoad {
    ...
    CGRect cmtFrame = CGRectMake(0,1200, self.view.frame.size.width, 40);
    txtframe=cmtFrame;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row==0)
    {
        ...
        // code ends for checking the iphone or ipad device
...
- (IBAction)btnAssignmentClick:(id)sender {
    ...
    [[appDelegate _engine] getAssignmentsByFeedId:userId AndFeedId:feedId  success:^(NSMutableArray *assignmentList) {
        [appDelegate hideSpinner];
        //Hide Indicator
        AssignmentViewController *assignment=[[AssignmentViewController alloc]init];
        assignment.arrayAssignment=assignmentList;
         assignment.comeFromUpdate=YES;
