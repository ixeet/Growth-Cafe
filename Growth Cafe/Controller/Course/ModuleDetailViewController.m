...
@synthesize txtSearchBar,feedId,scollViewContainer;
...
//        }
        ...
        if([resource.islike isEqualToString:@"1"])
        {
            ...
            if([resource.likeCounts integerValue]>1){
                [customView.btnLike setTitle:[NSString stringWithFormat:@"%@ Likes",resource.likeCounts] forState:UIControlStateSelected];
            }
        }else
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.section==0)
    {
        ...
        if([selectedResource.islike isEqualToString:@"1"])
        {
            ...
            if([selectedResource.likeCounts integerValue]>1){
                [cell.btnLike setTitle:[NSString stringWithFormat:@"%@ Likes",selectedResource.likeCounts] forState:UIControlStateSelected];
            }
        }else
       ...
       [cell.btnComment setTitle:selectedResource.commentCounts forState:UIControlStateNormal];
        ...
        {
            cell.btnLike.selected=YES;
                        if([comment.likeCounts integerValue]>1){
                [cell.btnLike setTitle:[NSString stringWithFormat:@"%@ Likes",comment.likeCounts] forState:UIControlStateSelected];
            }
        }else
