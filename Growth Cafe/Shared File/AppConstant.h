...
#define GET_ASSIGNMENT_BY_FEEDID_URL(feedid) [NSString stringWithFormat:@"%@/rest/common/getAssignment/feedId/%@", APP_URL,feedid]
//http://191.239.57.54:8081/SLMS/rest/common/getAssignment/feedId/
