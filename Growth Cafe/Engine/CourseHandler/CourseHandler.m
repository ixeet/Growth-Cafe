...
-(void)getCourse:(NSString*)userid AndFilter:(NSMutableDictionary*)dicfilter  success:(void (^)(NSMutableArray *courses))success   failure:(void (^)(NSError *error))failure{
    ...
    NSDictionary *parameters = @{@"userId":userid,
                                 @"schoolId":[dicfilter objectForKey:@"schoolId"],@"classId":[dicfilter objectForKey:@"classId"],@"hrmId":[dicfilter objectForKey:@"homeRoomId"],@"courseId":[dicfilter objectForKey:@"courseId"]
                                 };
