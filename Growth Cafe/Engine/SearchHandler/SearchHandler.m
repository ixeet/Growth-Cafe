    ...
    [manager POST:url parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([[responseDic objectForKey:key_severRespond_Status] integerValue] == 1001) { //Success
            ...
            //call Block function
                ...
                for (NSDictionary *dicUser  in [dicSearch objectForKey:@"usersList"]) {
                 ...
                 [dicSearchResult setObject:userList forKey:@"user"];
                  [dicSearchResult setObject:[dicSearch objectForKey:@"totalUsersCount"] forKey:@"totalUsersCount"];
            ...
            //call Block function
                ...
                [dicSearchResult setObject:[dicSearch objectForKey:@"totalFeedsCount"] forKey:@"totalFeedsCount"];
            }
                ...
                for (NSDictionary *dicCourse  in [dicSearch objectForKey:@"courseList"]) {
                 ...
                 [dicSearchResult setObject:[dicSearch objectForKey:@"totalCoursesCount"] forKey:@"totalCoursesCount"];
            }
                ...
                for (NSDictionary *dicAssign  in [dicSearch objectForKey:@"assignmentList"]) {
                    ...
                    assign.assignmentName=[dicAssign objectForKey:@"assignmentName"];
                    assign.assignmentSubmittedBy=[dicAssign objectForKey:@"assignmentSubmittedBy"];
                     assign.assignmentSubmittedById=[dicAssign objectForKey:@"assignmentSubmittedById"];
               
                    [assignmentList addObject:assign];
                }
                 [dicSearchResult setObject:assignmentList forKey:@"assignment"];
                 [dicSearchResult setObject:[dicSearch objectForKey:@"totalAssignmentsCount"] forKey:@"totalAssignmentsCount"];
            }
